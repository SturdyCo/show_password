...
visibilityOnElement.addEventListener("click", function(e) {
  ...
  visibilityOnElement.setAttribute("style", svgStyle + "display: none;")
  visibilityOffElement.setAttribute("style", svgStyle + "display: inline;")
})

visibilityOffElement.addEventListener("click", function(e) {
  var input = e.target.parentElement.parentElement.querySelector("input")
  input.setAttribute("type", "password")
  visibilityOnElement.setAttribute("style", svgStyle + "display: inline;")
  visibilityOffElement.setAttribute("style", svgStyle + "display: none;")
})
